...
public class ModSliderOption extends ModOption<Float> {
	...
	*/
	public ModOption setValue(Float value) {
	...
	*/
	public ModOption setValue(Float value, boolean scope) {
	...
	*/
    ...
    return setValue(Float.valueOf(strValue), scope);
  }
	...
	* @param	value	Value being set
	*/
	public ModOption setLocalValue(int value) {
		return setLocalValue((float) value);
	}
	...
	* @param	value	Value being set
	*/
	public ModOption setGlobalValue(int value) {
		return setGlobalValue((float) value);
	}
